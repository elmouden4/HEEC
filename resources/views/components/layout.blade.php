    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex shrink-0 items-center">
          <img class="h-8 w-auto" src="https://laracasts.com/images/logo/logo-triangle.svg" alt="logo" />
        </div>
...
<header>
        <h1 class="text-2xl font-bold text-center mt-4">{{$header}}</h1>
        <p class="text-center text-gray-600 mt-2">{{ $discription }}</p>
</header>
